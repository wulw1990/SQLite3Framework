...
FOUNDATION_EXPORT double SQLite3FrameworkVersionNumber;

//! Project version string for SQLite3Framework.
FOUNDATION_EXPORT const unsigned char SQLite3FrameworkVersionString[];
